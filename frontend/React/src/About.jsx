...
import enoiz from "./assets/image/enoiz019r2t41.png"
function About() {
  ...
  t1.to(".heading", {
   ...
   gsap.to(".heading",{
   keyframes: [
        { backgroundColor: "aqua", duration: 0.3 },
        { backgroundColor: "mint", duration: 0.3 },
        { backgroundColor: "skyblue", duration: 0.3 },
        { backgroundColor: "aquamarine", duration: 0.3 }
      ],
   yoyo: true,  
    repeat: -1,
    repeatDelay: 0.3,
  ...
  return (
    ...
    <div className="container">
     ...
     <div className="jus1"><p className="color-text">
      <div className="heading">WE ARE VALORANT<p>Valorant is a team-based first-person tactical
